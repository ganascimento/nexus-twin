...
| 30  | integration_tests_invariants_and_edges | pending | Varredura forense 2: invariantes por tick (conservação, não-negatividade, stock_reserved<=stock), cadeias de eventos (resupply_delivered, truck_arrived), deletion cascade com zombie reservations, stop_production mid-flight, guardrail semantico, zombie/orphan state detection, false-positives remanescentes do Bloco G. 5 bugs suspeitos a confirmar (BUG-30-1..5). |
