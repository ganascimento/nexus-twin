...
async def seed_default_world(session: AsyncSession) -> None:
    ...
    await session.execute(
        pg_insert(Truck).values([
            ...
            {"id": "truck-003", "truck_type": "proprietario", "capacity_tons": 12, "base_lat": -23.5015, "base_lng": -47.4526, "current_lat": -23.5015, "current_lng": -47.4526, "degradation": 0.30, "breakdown_risk": 0.0, "status": "idle", "factory_id": "factory-002", "cargo": None, "active_route_id": None},
